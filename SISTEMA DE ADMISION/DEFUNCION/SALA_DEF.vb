...
Public Class SALA_DEF
    ...
    Private Sub SALA_DEF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CONE.Open()
        Try
    ...
    Private Sub TXTCODIGO_TextChanged(sender As Object, e As EventArgs) Handles TXTCODIGO.TextChanged
        ...
        Try
            ...
            Dim COMANDO As String = "SELECT CODIGO, SALA FROM SALAS WHERE CODIGO LIKE '" _
                & "%" & TXTCODIGO.Text & "%" & "' AND SALA LIKE '" & "%" & TXTSALA.Text & "%" & "'"
            Dim ADAPTADOR As New SqlDataAdapter(COMANDO, CONE)
            Dim DATO As New DataTable
            ADAPTADOR.Fill(DATO)
            If DATO.Rows.Count > 0 Then
    ...
    Private Sub BTNACEPTAR_Click(sender As Object, e As EventArgs) Handles BTNACEPTAR.Click
        ...
        If DGVGENERAL.ColumnCount > 0 Then
            ...
            REC_DEFUNCION.TXTSALA.Text = DGVGENERAL.Item(1, A).Value() 'NOMBRE DE LA SALA
        End If
        Me.Close()
    End Sub
