...
Public Class BUSCAR_SALHOS
    ...
    Private Sub BTNACEPTAR_Click(sender As Object, e As EventArgs) Handles BTNACEPTAR.Click
        ...
        If DGVGENERAL.Rows.Count > 0 Then
            ...
            HOSPITALIZACION.TXTSALA.Text = DGVGENERAL.Item(1, A).Value() 'NOMBRE DE LA SALA
    ...
    Private Sub BUSCAR_SALHOS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CONE.Open()
        Try
