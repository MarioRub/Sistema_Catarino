...
Public Class CONTACTO_IMPRONTO
    ...
    Sub BUSQUEDA_CORRELATIVO()
        ...
        TXTTOTAL.Text = DGVGENERAL.Rows.Count
    End Sub
    Private Sub CONTACTO_IMPRONTO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BTNACEPTAR_Click(sender As Object, e As EventArgs) Handles BTNACEPTAR.Click
        ...
        If DGVGENERAL.ColumnCount > 0 Then
            ...
            IMPRONTO.TXTRESPONSABLE.Text = DGVGENERAL.Item(2, A).Value() 'NOMBRE DEL CONTACTO
            IMPRONTO.CMBPARENTEZCO.Text = DGVGENERAL.Item(3, A).Value() 'PARENTEZCO
            IMPRONTO.TXTDIRECCION.Text = DGVGENERAL.Item(4, A).Value() 'DIRECCION DEL CONTACTO
            IMPRONTO.TXTTELEFONO1.Text = DGVGENERAL.Item(5, A).Value() 'TELEFONO 1 DEL CONTACTO
            IMPRONTO.TXTTELEFONO2.Text = DGVGENERAL.Item(6, A).Value() 'TELEFONO 2 DEL CONTACTO
            IMPRONTO.TXTVALOR.Text = "SI"
