...
Public Class RETORNO_EXPEDIENTE
    ...
    Private Sub BTNCONFIRMAR_Click(sender As Object, e As EventArgs) Handles BTNCONFIRMAR.Click
        ...
        If CMBBUSQUEDA.Text = "IDENTIDAD" Then
            ...
            Try
                Dim GUARDAR As String = "UPDATE SOLICITUD_EXPEDIENTE SET ESTADO='" & "ENTREGADO'" & " ,COMENTARIO='" & TXTCOMENTARIO.Text & "', FECHA_ENTREGA='" & FECHA & "'  WHERE IDENTIDAD='" & TXTEXPEDIENTE.Text & "' AND NO = (SELECT MAX(NO) FROM SOLICITUD_EXPEDIENTE)"
        ...
        If CMBBUSQUEDA.Text = "CORRELATIVO" Then
            ...
            Dim ESTADO As String = ""
            Try
                Dim GUARDAR As String = "UPDATE SOLICITUD_EXPEDIENTE SET ESTADO='" & "ENTREGADO'" & " ,COMENTARIO='" & TXTCOMENTARIO.Text & "', FECHA_ENTREGA='" & FECHA & "'  WHERE CORRELATIVO='" & TXTEXPEDIENTE.Text & "' AND NO = (SELECT MAX(NO) FROM SOLICITUD_EXPEDIENTE)"
